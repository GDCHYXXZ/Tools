...
namespace NEWAB.PEditor
{
    /// <summary>
    /// PEditorClass class implementing custom ESRI Editor Extension functionalities.
    /// </summary>
    public class PEditorClass : ESRI.ArcGIS.Desktop.AddIns.Extension
    {
        public PEditorClass()
        {
        }
